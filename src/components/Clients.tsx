      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row gap-12 items-center">
          ...
          >
            ...
            <h3 className="text-3xl font-bold text-white mb-4">함께 성장할<br/>파트너를 찾습니다</h3>
          ...
          <div className="w-full md:w-2/3 grid grid-cols-2 gap-4">
            {targets.map((target, idx) => (
              <motion.div
                ...
                className="bg-card/50 border border-border/50 rounded-2xl p-6 flex flex-col items-center justify-center text-center hover:bg-card transition-colors group"
              >
